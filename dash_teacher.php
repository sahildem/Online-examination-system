...
<title>ONLINE EXAM DASHBOARD </title>
 ...
 <link  rel="stylesheet" href="css/dash_teacher.css">
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Teachers Dashboard</span></div>
<?php
...
include_once 'database.php';
echo '<span class="pull-right top title1" ><span class="log1">&nbsp;&nbsp;&nbsp;Hello,</span> <a  class="log log1"><b style="color:black;">Teacher</b></a>&nbsp;|&nbsp;<a href="logout.php?q=dash_teacher.php" class="log">Signout</button></a></span>';
}?>
...
<nav class="navbar navbar-default title1">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="dash_teacher.php?q=0">Home</a></li>
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="dash_teacher.php?q=1">User</a></li>
		    <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="dash_teacher.php?q=2">Ranking</a></li>  
        <li><a href="dash_teacher.php?q=3">Add Exam</a></li>
        <li><a href="dash_teacher.php?q=4">Remove Exam</a></li>
      </ul>
          </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
...
echo '<tr style="color:black"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
	<td><b><a href="update_teacher.php?q=quizre&step=25&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Restart</b></span></a></b></td></tr>';
}
}
$c=0;
echo '</table></div>';
...
$c++;
echo '<tr><td style="color:black2"><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$s.'</td><td>';
}
echo '</table></div>';}
...
$result = mysqli_query($mysqli,"SELECT * FROM user") or die('Error');
echo  '<div class="panel"><table class="table table-striped title1">
...
while($row = mysqli_fetch_array($result)) {
	...
	//<td><a title="Delete User" href="update_teacher.php?demail='.$email.'"><b>Remove User</span></b></a></td></tr>';
}
$c=0;
echo '</table></div>';
...
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Exam Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" action="update_teacher.php?q=addquiz"  method="POST">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <textarea rows="8" cols="55" name="desc" class="form-control" placeholder="Write description here..." id="t"></textarea>  
  </div>
</div>
...
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Question Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6"><form class="form-horizontal title1" name="form" action="update_teacher.php?q=addqns&n='.@$_GET['n'].'&eid='.@$_GET['eid'].'&ch=4 "  method="POST">
<fieldset>
';
 ...
 {
echo '<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Question number&nbsp;'.$i.'&nbsp;:</><br /><!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="qns'.$i.' "></label>  
  <div class="col-md-12">
  <textarea rows="5" cols="34" name="qns'.$i.'" class="form-control" id="t1" placeholder="Write question number '.$i.' here..." required></textarea>  
  </div>
</div>
<!-- Text input-->
<div class="form-group">
...
<br />
<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style="background:green;color:white">Correct answer:</b></b><br />
...
while($row = mysqli_fetch_array($result)) {
	...
	$eid = $row['eid'];
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
	<td><b><a href="update_teacher.php?q=rmquiz&eid='.$eid.'" class="pull-right btn sub1" style="margin:0px;background:whitesmoke">&nbsp;<span class="title1"><b>Remove</b></span></a></b></td></tr>';
}
$c=0;
echo '</table></div>';
